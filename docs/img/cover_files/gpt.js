(function (F, S) {
  ...
  var fa = ba,
    ...
    t = function (a, b) {
      ...
      a.J = function (d, e, f) {
        for (
          var h = Array(arguments.length - 2), p = 2;
          p < arguments.length;
          p++
        )
          h[p - 2] = arguments[p];
  ...
  var za = function (a) {
      return a instanceof y && a.constructor === y && a.g === ya
        ? a.a
        : "type_error:SafeUrl";
    },
    Aa = /^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i,
    ya = {},
    Ba = function (a) {
      var b = new y();
      b.a = a;
  ...
  var B = function () {},
        ...
        for (b = 0; b < c.length; b++)
          (e = c[b]),
            e < a.h
              ? ((e += a.g), (a.b[e] = a.b[e] || C))
              : (Ga(a), (a.c[e] = a.c[e] || C));
      if (d && d.length) for (b = 0; b < d.length; b++) Ha(a, d[b]);
    },
    C = [],
    Ga = function (a) {
      var b = a.h + a.g;
    ...
    Ja = function (a, b, c) {
      b < a.h ? (a.b[b + a.g] = c) : (Ga(a), (a.c[b] = c));
    },
    Ha = function (a, b) {
      for (var c, d, e = 0; e < b.length; e++) {
        var f = b[e],
          h = E(a, f);
        null != h && ((c = f), (d = h), Ja(a, f, void 0));
      }
      return c ? (Ja(a, c, d), c) : 0;
    },
    H = function (a, b, c) {
      a.a || (a.a = {});
      if (!a.a[c]) {
  ...
  var Qa = function (a, b) {
    ...
    Ta = /^(-?[0-9.]{1,30})$/,
    Ua = function (a, b) {
      return Ta.test(a) && ((a = Number(a)), !isNaN(a))
        ? a
        : void 0 == b
        ? null
        : b;
  ...
  var ab = function (a) {
    ...
    db = function (a, b) {
      var c = I(a, L, 2);
      if (!c.length) return cb(a, b);
      a = G(a, 1, 0);
      if (1 == a) return ab(db(c[0], b));
      c = oa(c, function (d) {
        return function () {
          return db(d, b);
        };
  ...
  var kb = function (a, b) {
    ...
    lb = function (a, b) {
      ...
      switch (b) {
        case 1:
          return (a = E(a, 1)), (a = null == a ? a : !!a), null == a ? !1 : a;
        case 2:
          return Ia(a, 2);
        case 3:
          return G(a, 3, "");
    ...
    ob = function (a) {
      var b = N.f().a;
      if (b) {
        var c = qa(I(a, jb, 5), function (d) {
          return eb(H(d, L, 1), b);
        });
        if (c) return H(c, gb, 2);
      }
      return H(a, gb, 4);
    },
    nb = function () {
  ...
  q(nb);
  var qb = function (a, b) {
      return pb(1, a, void 0 === b ? !1 : b);
    },
    rb = function (a, b) {
      return pb(2, a, void 0 === b ? 0 : b);
    },
    sb = function (a, b) {
      return pb(3, a, void 0 === b ? "" : b);
    },
    tb = function (a, b) {
      b = void 0 === b ? [] : b;
      return pb(6, a, b);
  ...
  var Rb = function (a, b) {
    ...
    Tb = function (a, b) {
      a.b = na(a.b, function (c) {
        return G(c, 1, 0) != b;
      });
    },
    Ub = function (a, b) {
      var c = N.f().a;
      if (!eb(H(b, L, 3), c)) return null;
      var d = I(b, Kb, 2),
        e = c
          ? na(d, function (h) {
              return eb(H(h, L, 3), c);
      ...
      d = G(b, 4, 0);
      b = f * G(b, 1, 0);
      if (!d) return Wb(a, e, b / 1e3);
      f = null != a.c[d] ? a.c[d] : 1e3;
      if (0 >= f) return null;
      e = Wb(a, e, b / f);
      a.c[d] = e ? 0 : f - b;
      return e;
    ...
    cc = function (a, b, c, d, e) {
      ...
      try {
        ...
        if (-1 != c.toLowerCase().indexOf("stylesheet"))
          ...
          if (b instanceof x) var p = ua(b).toString();
          else {
            if (b instanceof y) var v = za(b);
            else {
              if (b instanceof y) var O = b;
              else
                (b = "object" == typeof b && b.c ? b.b() : String(b)),
  ...
  var dc = /^\.google\.(com?\.)?[a-z]{2,3}$/,
    ec = /\.(cn|com\.bi|do|sl|ba|by|ma|am)$/,
    fc = function (a) {
      return dc.test(a) && !ec.test(a);
    },
    gc = function (a) {
  ...
  var nc = function (a) {
    ...
    oc = function (a, b, c) {
      ...
      ic();
      1 == c ? a.C() : a.B();
      if (!d && a.G()) fc(".google.com") && (V[1] = ".google.com"), a.j();
      else {
        var v = (T.googleToken = T.googleToken || {}),
          O =
            0 == c && d && k(d) && !e && l(f) && 0 < f && l(h) && 0 < h && k(p);
        e = e && !a.i() && (!(U[3] >= +new Date()) || "NT" == U[1]);
        var ta = !(U[3] >= +new Date()) && 0 != c;
        if (O || e || ta)
          (e = +new Date()),
            (f = e + 1e3 * f),
            (h = e + 1e3 * h),
  ...
  rc.prototype.b = function (a, b, c, d, e) {
  ...
  var tc = function (a, b) {
    try {
      ...
      if (!a.c(420, c, 0.01, void 0, "gpt_exception")) throw c;
    }
  };
  var uc = function (a) {
  ...
  var J = function (a) {
    ...
    Bc = zc._vars_,
    Cc;
  for (Cc in Bc) Ac[Cc] = Bc[Cc];
  zc._vars_ = Ac;
  var Dc = function (a) {
    Rb.call(this, a, { v: J(211), A: J(227), D: J(226) });
  };
  ha(Dc, Rb);
  var Ec = function () {
    return J(36);
  ...
  var Kc = { l: [], s: {} },
    Mc = function (a) {
      a = a || Kc;
      Sa() && Z(210, ra(a.s));
      J(219).length || Z(219, a.l);
      var b = Lc();
      Dc.call(this, I(b, Qb, 2));
      var c = this;
      a = Jc.f();
      a[3][6] = function (d) {
        a: {
  ...
  var Nc = A("www.googletagservices.com"),
    Oc = function () {
      return !J(46) || J(6) || Zb(152)
        ...
        a: {
          if ((a = a.scripts))
            for (c = 0; c < a.length; c++) {
              var d = a[c];
              if (-1 < d.src.indexOf(Nc + "/tag/js/gpt")) {
                c = d;
                break a;
              }
            }
    ...
    Tc = function (a, b, c) {
      ...
      if (d.evalScripts) d.evalScripts();
        ...
        Rc(b, c);
        a.PerformanceObserver && a.PerformanceLongTaskTiming && uc(a);
        vc(a);
        a = Qc();
        if (Pc(b)) {
          ...
          try {
            ...
            Zb(17) &&
              bc() &&
              (e += '<link rel="preconnect" href="' + Oc() + '">');
            b.write(e);
          } catch (f) {}
          b.getElementById(c) && ((d._loadStarted_ = !0), Z(220, !1), qc());
        }
        d._loadStarted_ ||
          (pc(),
          Zb(16) && cc(b, a, "preload", "script"),
          (c = b.createElement("script")),
          (c.src = a),
          (c.async = !0),
          (b.head || b.body || b.documentElement).appendChild(c),
          Zb(17) && bc() && cc(b, Oc(), "preconnect"),
          Z(220, !0),
          (d._loadStarted_ = !0));
        (b = Sc()) &&
          b.catch(function (f) {
  ...
  a: {
    try {
      ...
      if ((Vc = "array" == r(F))) {
        var Wc = S,
          Xc = typeof Wc;
        Vc = ("object" == Xc && null != Wc) || "function" == Xc;
      }
      if (Vc) {
        Uc = { l: F, s: S };
        break a;
  ...
  [
    ...
    [
      ...
      null,
      9,
      [null, null, "https://securepubads.g.doubleclick.net/pagead/js/rum.js"],
    ],
    [45, null, null, []],
  ...
  ],
  {
    ...
    3: [
      ...
      [
        ...
        [
          [21063363],
          [21063364, [[null, 16, null, [null, 500]]]],
          [21063365, [[null, 16, null, [null, 1000]]]],
          [21063368, [[null, 18, null, [null, 500]]]],
          [21063369, [[null, 18, null, [null, 1000]]]],
        ],
      ],
      [10, [[21063387], [21063388, [[130, null, null, [1]]]]]],
      [50, [[21063505], [21063506, [[140, null, null, [1]]]]]],
      [
        null,
        [
          [21063616],
          ...
          [21063618, [[null, null, 2, [null, null, "1-0-33"]]]],
        ],
      ],
      [
        1,
      ...
      [10, [[21063643], [21063644, [[118, null, null, [1]]]]]],
      [
        10,
        [
          [21063661],
          [21063662, [[null, 13, null, [null, 1]]]],
          [21063663, [[null, 13, null, [null, 2]]]],
        ],
      ],
      [
        1,
      ...
      [50, [[21063740], [21063741, [[119, null, null, []]]]]],
      [50, [[21063760], [21063761, [[155, null, null, [1]]]]]],
      [
        10,
        [
          [21063778],
      ...
      [1, [[21063813], [21063814, [[151, null, null, [1]]]]]],
      [
        1,
        [
          [21063815],
      ...
      [
        ...
        [
          [21063854],
          [21063855, [[110, null, null, [1]]]],
          [21063856, [[69, null, null, [1]]]],
        ],
        null,
        11,
      ],
      [
        ...
        [
          [21063867],
          [21063868, [[153, null, null, [1]]]],
          [21063869, [[146, null, null, [1]]]],
        ],
      ],
      [
        1000,
    ...
    4: [
      ...
      [null, [[21063411], [21063412], [21063413]]],
      [null, [[21063414], [21063415]]],
      [null, [[21063421], [21063422], [21063423, [[74, null, null, [1]]]]]],
      [null, [[21063599], [21063600, [[105, null, null, [1]]]]]],
      [
        null,
        [
          [21063802],
      ...
      [
        ...
        [
          [
            ...
            [
              [null, 7, null, [null, 1]],
              [null, null, 5, [null, null, "21063861"]],
              [60, null, null, [1]],
              [null, null, 6, [null, null, "21063861"]],
            ],
      ...
      [
        ...
        [
          [
            ...
            [
              [null, 7, null, [null, 1]],
              [null, null, 5, [null, null, "21063863"]],
              [60, null, null, [1]],
              [null, null, 6, [null, null, "21063863"]],
            ],
            [6, null, null, 4, null, 4],
          ],
          [
