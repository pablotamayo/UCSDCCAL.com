function RisParser(g, r) {
  ...
  var e = {
    ...
    s = [];
  (c = c.split("ER  -")),
    CwZ.each(c, function (g) {
      n.push(c[g].split("TY  -")[1]);
    }),
    CwZ.each(n, function (g) {
      var r = n[g];
      r.length && !ccUtils.checkHtmlTags.test(r) && s.push(r);
    }),
    (c = s.join("ER  -\n\nTY  -")),
    (c = "TY  -" + c),
    (c = CwZ.trim(c).split("ER  -"));
  var l = { entries: [] },
    h = CwZ.isEmptyObject(r),
    o = !1;
  for (var d in c)
    if (~c[d].indexOf("TY  -")) {
      var y = CwZ.trim(c[d]),
      ...
      for (var u in y) {
        ...
        if (~R) {
          ...
          if (2 == m.length) {
            ...
            if (A) {
              var S = m;
              "A" != S[0] || ("U" != S[1] && isNaN(parseInt(S[1])))
                ? (p[m] = C)
                : (p[m] = A + " and " + C);
            } else p[m] = C;
          }
      ...
      for (
        var b = p.AU ? p.AU : "", f = 1;
        void 0 !== p["A" + f] || void 0 !== p["A" + ++f];

      )
        (o = !0),
          (b += ("" != b ? " and " : "") + p["A" + f]),
          delete p["A" + f];
      "" == b ? (b = h || "" == r.authors ? "" : r.authors) : delete p.AU;
      var _ = {};
      for (var v in ((E[e.DO] =
        p.DO || (h || "" == r.identifier ? "" : r.identifier)),
      delete p.DO,
      (E[e.TY] = t[p.TY] || t.JOUR),
      delete p.TY,
      (_[e["A" + (o ? "1" : "U")]] = b),
      p))
        _[e[v]] || (void 0 !== e[v] ? (_[e[v]] = p[v]) : (_[v] = p[v]));
      (E.Fields = _), delete E.Fields.eof, l.entries.push(E);
    }
  return l;
}
function BibtexParser(g) {
  if ("string" == typeof g) {
    var r = [];
    var e = BibtexParser.call({}, function (g) {
      r.push(g);
    });
    return e.parse(g), { entries: r, errors: e.getErrors() };
  }
  if ("function" != typeof g) throw "Invalid parser construction.";
  return (
    (this.STATES_ = {
      ENTRY_OR_JUNK: 0,
      OBJECT_TYPE: 1,
    ...
    (this.parse = function (g) {
      for (var r = 0; r < g.length; r++) this.processCharacter_(g[r]);
    }),
    (this.error_ = function (g) {
      this.ERRORS_.push([this.LINE_, this.CHAR_IN_LINE_, this.CHAR_, g]);
    }),
    (this.processEntry_ = function () {
      var g = this.DATA_;
      if (g.Fields)
        for (var r in g.Fields) {
          for (var e = g.Fields[r], t = 0; t < this.CHARCONV_.length; t++) {
            var i = this.CHARCONV_[t][0],
              a = this.CHARCONV_[t][1];
            e = e.replace(i, a);
          }
          e = e
            .replace(/[\n\r\t]/g, " ")
      ...
      if ("string" == g.ObjectType)
        for (var r in g.Fields) this.MACROS_[r] = g.Fields[r];
      else this.CALLBACK_(g);
    }),
    (this.processCharacter_ = function (g) {
      if (
        (this.CHAR_++,
        this.CHAR_IN_LINE_++,
        "\n" == g && (this.LINE_++, (this.CHAR_IN_LINE_ = 1)),
        this.SKIPTILLEOL_)
      )
        "\n" == g && (this.SKIPTILLEOL_ = !1);
      else if (this.SKIPCOMMENT_ && "%" == g) this.SKIPTILLEOL_ = !0;
      else if (!this.SKIPWS_ || !/\s/.test(g)) {
        (this.SKIPWS_ = !1), (this.SKIPCOMMENT_ = !1), (this.SKIPTILLEOL_ = !1);
        for (var r = !0; r; )
          switch (((r = !1), this.STATE_)) {
            ...
            case this.STATES_.OBJECT_TYPE:
              if (/[A-Za-z]/.test(g))
                (this.DATA_.ObjectType += g.toLowerCase()),
                  (this.SKIPWS_ = !0),
                  (this.SKIPCOMMENT_ = !0);
              else {
                var e = this.DATA_.ObjectType;
                "comment" == e
                  ? (this.STATE_ = this.STATES_.ENTRY_OR_JUNK)
                  : "string" == e
                  ? ((this.DATA_.ObjectType = e),
                    (this.DATA_.Fields = {}),
                    (this.BRACETYPE_ = g),
                    (this.BRACECOUNT_ = 1),
                  ...
                  : "preamble" == e
                  ? (this.STATE_ = this.STATES_.ENTRY_OR_JUNK)
                  : e in this.ENTRY_TYPES_
                  ? ((this.DATA_.ObjectType = "entry"),
                    (this.DATA_.EntryType = e),
                    (this.DATA_.EntryKey = ""),
            ...
            case this.STATES_.ENTRY_KEY:
              ...
              /[,%\s]/.test(g)
                ? this.DATA_.EntryKey.length < 1
                  ? ((this.SKIPWS_ = !0), (this.SKIPCOMMENT_ = !0))
                  : null == this.BRACETYPE_
            ...
            case this.STATES_.KV_KEY:
              ...
              /[\-A-Za-z:]/.test(g)
                ? ((this.PARSETMP_.Key += g),
                  (this.SKIPWS_ = !1),
                  (this.SKIPCOMMENT_ = !1))
                : this.PARSETMP_.Key.length < 1
                ? ((this.SKIPWS_ = !0), (this.SKIPCOMMENT_ = !0))
                : ((this.SKIPWS_ = !0),
                  (this.SKIPCOMMENT_ = !0),
            ...
            case this.STATES_.KV_VALUE:
              var t = this.VALBRACES_,
                i = this.PARSETMP_.Value,
                a = !1;
              if ('"' == g || "{" == g || "}" == g || "," == g) {
                if ("," == g && 0 === t['"'].length + t["{"].length) {
                  var c = this.PARSETMP_.Value.trim();
                  c in this.MACROS_
                    ? (this.PARSETMP_.Value = this.MACROS_[c])
                    : this.error_("Reference to an undefined macro: " + c),
                    (a = !0);
                }
                if ('"' == g) {
                  if (0 === t['"'].length + t["{"].length) {
                    t['"'].push(this.CHAR_),
                      (this.SKIPWS_ = !1),
                      (this.SKIPCOMMENT_ = !1);
                    break;
...
function BibTeXGenerator(g) {
  for (var r = [], e = 0; e < g.length; e++) {
    var t,
      i = g[e];
    (t = "@" + i.EntryType + "{" + i.EntryKey + ",\n"),
      (i = i.Fields || i.fields);
    var a = "";
    for (var c in i) a += "\t" + c + '="' + i[c] + '",\n';
    (a = a.slice(0, -2)), r.push(t + a + "\n}");
  }
  return r;
}
function RisGenerator(g) {
  for (
    var r = [],
      e = [
        "article",
    ...
    var a,
      ...
      S = "",
      b = "",
      f = CwZ.inArray(c.EntryType, e);
    if (
      (c.EntryKey && (y = "DO  - " + c.EntryKey + "\n"),
      (a = "TY  - " + (t[e[f]] || t.article) + "\n"),
      (c = c.Fields || c.fields),
      c.author || c.authors)
    ) {
      var _ = c.author || c.authors;
      (_ = _.split(" and ")), (s = "");
      for (var v = 0; v < _.length; v++)
        (s += 0 == v ? "AU  - " + _[v] : "A" + (v + 1) + "  - " + _[v]),
          (s += "\n");
    }
    if (
      (c.abstract && (l = "AB  - " + c.abstract + "\n"),
      c.title && (h = "TI  - " + c.title + "\n"),
      c.journal && (o = "JO  - " + c.journal + "\n"),
      c.date || c.year)
    )
      try {
        var Y = "DA  - ",
          ...
          P = "";
        if (c.date) {
          if (((w = new Date(c.date)), isNaN(w)))
            throw new Error("Invalid Date");
          P = w.getFullYear() + "/" + (w.getMonth() + 1) + "/" + w.getDate();
        } else if (c.year) {
          Y = "PY  - ";
          R = c.year;
          if (c.month) {
            var O = c.month;
            if (
              ((w = new Date(O + " " + R) || ""), (w = isNaN(w) ? "" : w), !w)
            )
              throw new Error("Invalid Date");
            P = w.getFullYear() + "/" + (w.getMonth() + 1);
          } else {
            if (((w = new Date(R)), (w = isNaN(w) ? "" : w), !w))
              throw new Error("Invalid Date");
            P = w.getFullYear();
          }
        }
        if ("nan" != P.toString().toLowerCase() || "" != P.toString()) {
          var N = P.toString().match(/(\/)/g);
          if (N) var q = N.length;
          else q = 0;
          for (v = q; v < 3; v++) P += "/";
          isNaN(new Date(P)) || ((d += Y + P + "\n"), (R = ""));
        }
      } catch (g) {
        (d = ""), (R = "");
      }
    c.issue
      ? (E = "ET  - " + c.issue + "\n")
      : c.edition && (E = "ET  - " + c.edition + "\n"),
      c.isbn
        ? (m = "SN  - " + c.isbn + "\n")
        : c.issn && (m = "SN  - " + c.issn + "\n"),
      c.keywords && (p = "KW  - " + c.keywords),
      c.language && (u = "LA  - " + c.language + "\n"),
      c.publisher && (T = "PB  - " + c.publisher + "\n"),
      c.startPage && (C = "SP  - " + c.startPage + "\n"),
      c.endPage && (A = "EP  - " + c.endPage),
      c.url && (S = "UR  - " + c.url + "\n"),
      c.volume && (b = "VL  - " + c.volume + "\n"),
      (n +=
        a +
        s +
        l +
...
function converter(g, r, e) {
  "undefined" == e && (e = "array");
  var t = [];
  g instanceof Array ? (t = g) : t.push(g);
  var i = "";
  try {
    switch (r) {
      case "bib":
    ...
    return "string" == e && (i = i.join("\n\n")), i;
  }
}
function BibToRis(g) {
  var r = BibtexParser(g);
  return converter(r.entries, "ris", "string");
}
function RisToBib(g, r) {
  var e = RisParser(g, r);
  return converter(e.entries, "bib", "string");
}
function citConverterMain(g, r, e) {
  void 0 === e && (e = {});
  var t = "";
  try {
    "ris" == r ? (t = BibToRis(g, e)) : "bib" == r && (t = RisToBib(g, e));
  } catch (g) {
  } finally {
    return t;
  }
}
function citJSONMain(g, r, e) {
  void 0 === e && (e = {});
  var t = "";
  try {
    "ris" == r ? (t = RisParser(g)) : "bib" == r && (t = BibtexParser(g));
  } catch (g) {
  } finally {
    return t;
  }
...
"undefined" != typeof module &&
  module.exports &&
  ((module.exports = BibtexParser), (module.exports = RisParser));
var ccUtils = {
  checkHtmlTags: new RegExp("<[^>]+>"),
  trim: function (g) {
    return (
      (g =
        "string" == typeof g && g && g.length
          ? CwZ.trim(g).replace(/^\s+|\s+$|\s+(?=\s)/g, "")
          : ""),
      g
    );
  },
  splitValue: function (g, r) {
    return [g.substring(0, r), g.substring(r + 1)];
  },
};
