var CWPDFReaderMode, CWPDFReaderConfig, CWApiHandler;
...
(function (a) {
  a[(a.Chrome = 0)] = "Chrome";
  a[(a.Library = 1)] = "Library";
  a[(a.Publisher = 2)] = "Publisher";
  a[(a.Webimporter = 3)] = "Webimporter";
  a[(a.Drive = 4)] = "Drive";
  a[(a.Firefox = 5)] = "Firefox";
  a[(a.LibraryDesktop = 6)] = "LibraryDesktop";
  a[(a.OpenDrive = 7)] = "OpenDrive";
...
var colwizOptions_1,
  CWPDFReaderConfigClass = (function () {
    ...
    return (
      ...
      (a.prototype.setPublisher = function (a) {
        publisher.appId = a;
      }),
      a
    );
...
var CWMetaData = function (a) {
    ...
    this.identifier = a.identifier ? a.identifier : "";
    this.identifierType = a.identifierType ? a.identifierType : "";
    this.pdfLink = a.pdfLink ? a.pdfLink : "";
    this.pubLink = a.pubLink ? a.pubLink : "";
    this.refLink = a.refLink ? a.refLink : "";
    this.title = a.title ? a.title : "";
    this.authors = a.authors ? a.authors : "";
    this.index = a.index ? a.index : 0;
    this.psp = a.psp ? a.psp : 0;
    this.dataUrl = a.dataUrl ? a.dataUrl : "";
    this.data = a.data ? a.data : "";
    this.type = a.type ? a.type : "";
    this.issn = a.issn ? a.issn : "";
    this.journal = a.journal ? a.journal : "";
    this.publisher = a.publisher ? a.publisher : "";
    this.year = a.year ? a.year : "";
    this.openaccess = !!a.openaccess && a.openaccess;
    this.listingPage = !!a.listingPage && a.listingPage;
    this.keywords = a.keywords ? a.keywords : "";
    this.affiliation = a.affiliation ? a.affiliation : "";
    this.otherInfo = a.otherInfo ? a.otherInfo : "";
