(function () {
  ...
  var w = /:[0-9]+$/,
    y = function (a, b) {
      ...
      if ("protocol" === b || "port" === b)
        a.protocol = x(a.protocol) || x(r.location.protocol);
      "port" === b
        ? (a.port = String(
        ...
        if (a) {
          ...
          if (e && "1" === e[1]) {
            ...
            if (h) {
              b = {};
              var m = g ? g.split("*") : [];
              for (g = 0; g < m.length; g += 2) b[m[g]] = F(m[g + 1]);
              return b;
            }
          }
        }
  ...
  function W(a, b, c) {
    b.href &&
      ((a = T(a, b.href, void 0 === c ? !1 : c)), q.test(a) && (b.href = a));
  }
  function V(a, b) {
    if (b && b.action) {
      ...
      if ("get" === c) {
        ...
        "post" === c && ((a = T(a, b.action)), q.test(a) && (b.action = a));
    }
  }
  var X = function (a) {
      try {
