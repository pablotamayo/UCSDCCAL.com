!(function (n) {
  ...
  function (t, e, n) {
    ...
    function a(t) {
      ...
      "" == n && (n = f(t.getAttribute("data-fulltitle") || ""));
      var a = "";
      if (n) {
        var r = n.split(" "),
          i = r[0][0];
      ...
      if ((a = t.getAttribute("data-avatar"))) {
        var s = Math.abs(a[0].charCodeAt() - 64),
          l = 1 < a.length ? Math.abs(a[1].charCodeAt() - 64) : 0,
          c = s * l + s;
        t.setAttribute("style", "background-color:" + e[c % e.length]);
      }
    }
    function f(t) {
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, s) {
      (s = s || {}),
        void 0 === s.singleton && (s.singleton = r()),
        void 0 === s.insertAt && (s.insertAt = "bottom");
      var l = f(t);
      return (
        c(l, s),
        function (t) {
