...
function getPardotUrl() {
  var e = "pi.pardot.com";
  return (
    "string" == typeof piHostname && (e = piHostname),
...
function piTracker(e) {
  if (
    ...
    "false" != pi.tracker.pi_opt_in ||
      (void 0 !== pi.tracker.title && pi.tracker.notify_pi))
  ) {
    ...
    null != t
      ...
      (pi.tracker.url = void 0 !== e ? e : document.URL),
      (pi.tracker.referrer = document.referrer),
      null == pi.tracker.referrer &&
    ...
    null != p && (pi.tracker.device = p),
      "undefined" != typeof piIncludeInActivities &&
        (pi.tracker.pi_include_in_activies = piIncludeInActivities),
      "undefined" != typeof piProfileId &&
    ...
    null == f && (f = piGetParameter(document.URL, "_kk")),
      null != f && (pi.tracker.utm_term = f);
    var v = piGetParameter(document.URL, "gclid");
    null != v && (pi.tracker.gclid = v);
    var _ = "ver=3";
    for (property in pi.tracker)
      _ += "&" + property + "=" + encodeURIComponent(pi.tracker[property]);
    var g = !1;
    try {
      g = location.protocol + "//";
    } catch (e) {}
    if (
      (null == g && (g = "http://"),
      "string" != typeof piTUrl ||
        (-1 == piTUrl.indexOf("localhost") &&
          -1 === piTUrl.indexOf("app.dev.pardot")))
    )
...
function piSetCookie(e, t, r) {
  ...
  i.setDate(i.getDate() + r),
    (document.cookie =
      ...
      (null == r
        ? ""
        : ";expires=" + i.toGMTString() + ";path=" + escape("/")));
}
var piScriptNum = 0,
  ...
  (function () {
    function e(e) {
      ...
      for (i = 0; i < t.length; i++) {
        ...
        for (
          a || (a = t[i].className), ecl = a.split(" "), j = 0;
          j < ecl.length;
          j++
        )
    ...
    function t(t) {
      return "function" != typeof document.getElementsByClassName
        ? e(t)
        : document.getElementsByClassName(t);
    }
    function r(e) {
      var t,
        r = getPardotUrl() + "/analytics?",
        i = { url: encodeURIComponent(e), title: "", referrer: pi.tracker.url };
      for (t in pi.tracker)
        pi.tracker.hasOwnProperty(t) &&
          !i.hasOwnProperty(t) &&
          (i[t] = pi.tracker[t]),
          (r += "&" + t + "=" + i[t]);
    ...
    !(function () {
      ...
      for (e = t("pardotTrackClick"), i = 0; i < e.length; i++) {
        ...
        (a = e[i]).addEventListener
          ? a.addEventListener("click", n, !1)
          : a.attachEvent && a.attachEvent("onclick", n);
      }
    })();
  })();
